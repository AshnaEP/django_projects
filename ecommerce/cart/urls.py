...
urlpatterns = [
    ...
    path('addcart/<int:i>/',views.addtocart,name='addcart'),
    path('cartview',views.cartview,name='cartview'),
    path('decrementcart/<int:i>/',views.cart_decrement,name='decrementcart'),
    path('itemdelete/<int:i>/',views.delete_cart_item,name='itemdelete'),
